            ...
            <>
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="w-full bg-black/30 backdrop-blur-sm text-white px-6 py-3 rounded-lg border border-gray-600 hover:bg-gray-800/50 hover:border-gray-500 transition-all duration-300 font-medium flex items-center justify-center"
                >
                ...
                <button
                  ...
                  className="w-full bg-white text-gray-900 px-6 py-3 rounded-lg hover:bg-gray-100 transition-all duration-300 font-medium flex items-center justify-center border border-gray-300"
                >
